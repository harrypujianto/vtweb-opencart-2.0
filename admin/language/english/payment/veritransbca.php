<?php
// Heading
$_['heading_title']      = 'Veritrans BCA';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Veritrans account details!';
$_['text_veritransbca']     = '<a href="https://veritrans.co.id" target="_blank"><img src="view/image/payment/veritrans.png" width="120px" alt="Veritrans" title="Veritrans" style="border: 1px solid #EEEEEE;" /></a>';
