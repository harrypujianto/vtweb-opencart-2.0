<?php
// Heading
$_['heading_title']      = 'Veritrans Bni installment';

// Text
$_['text_payment']       = 'Payment';
$_['text_success']       = 'Success: You have modified Veritrans account details!';
$_['text_veritransbni']     = '<a href="https://veritrans.co.id" target="_blank"><img src="view/image/payment/veritrans.png" width="120px" alt="Veritrans" title="Veritrans" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['entry_installment_bni_term'] = 'Installment term';
